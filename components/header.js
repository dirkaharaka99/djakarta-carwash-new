    	...
    	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
			<a class="text-3xl font-bold leading-none" href="#">
				{/* <svg class="h-10" alt="logo" viewBox="0 0 10240 10240">
          		...
          		<img src="/images/logo.png" alt="alternative" className="h-16 " />
			...
			<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
				...
				<li>
					<Link className="text-sm text-gray-400 hover:text-gray-500" href="#features">
						Fitur
					</Link>
				</li>
				<li class="text-gray-300">
				...
				<li>
					<Link className="text-sm text-gray-400 hover:text-gray-500" href="#details">
						Detail
					</Link>
				</li>
				<li class="text-gray-300">
				...
				<li>
					<Link className="text-sm text-gray-400 hover:text-gray-500" href="#testimonial">
						Testimonial
					</Link>
				</li>
				<li class="text-gray-300">
				...
				<li>
					<Link className="text-sm text-gray-400 hover:text-gray-500" href="#pricing">
						Paket
					</Link>
				</li>
				<li class="text-gray-300">
				...
				<li>
					<Link className="text-sm text-gray-400 hover:text-gray-500" href="#footer">
						Kontak
					</Link>
				</li>
				<li class="text-gray-300">
			...
			<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
				...
				<div>
					<ul>
						...
						<li class="mb-1">
							<Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#features">
								Fitur
							</Link>
						</li>
						<li class="mb-1">
							<Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#details">
								Detail
							</Link>
						</li>
						<li class="mb-1">
							<Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#testimonial">
								Testimonial
							</Link>
						</li>
						<li class="mb-1">
							<Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#pricing">
								Paket
							</Link>
						</li>
						<li class="mb-1">
							<Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#footer">
								Kontak
							</Link>
						</li>
						<li class="mb-1">
